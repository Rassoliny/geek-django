...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('authapp', '0007_auto_20180916_1202'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.DateTimeField(default=datetime.datetime(2018, 9, 18, 16, 4, 18, 139022, tzinfo=utc), verbose_name='актуальность ключа'),
        ),
        migrations.AddField(
