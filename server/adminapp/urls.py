...
urlpatterns = [
    ...
    re_path(r'^categories/create', adminapp.product_create, name='category_create'),
    re_path(r'^categories/read', adminapp.categories, name='categories'),
    re_path(r'^categories/update/(?P<pk>\d+)', adminapp.product_update, name='category_update'),
    re_path(r'^categories/delete/(?P<pk>\d+)', adminapp.product_delete, name='category_delete'),
    ...
    re_path(r'^products/read/(?P<pk>\d+)', adminapp.product_read, name='product_read'),
